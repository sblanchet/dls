...
channels\-le  will be removed from the specifications. Any data acquired,
...
\item[Accuracy]  Some loss-afflicted compression methods allow specifying the
...
loss-free compression. See \autoref{sec:comp_zlib}.
...
types\index{channel!data types} and the respective possible\-lichen
compression methods.
