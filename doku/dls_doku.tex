...
Ein vom Benutzer oder System gestarteter dlsd-Prozess übernimmt die
Überwachung der Messaufträge\index{Messauftrag}. Er heißt dann
\textit{dlsd-Mutterprozess}. Er hält im Speicher eine Liste von eigenen Kopien
der im DLS-Datenverzeichnis vorhandenen Auftragsvorgaben vor, die zusätzlich
Informationen über die dazugehörigen Erfassungsprozesse enthalten.
...
erscheint hier als \textit{\textless d\textgreater}-Tag. Dieses erhält
...
\begin{table}[htb]
  ...
  \begin{tabular}[thb]{|l|l|l|} \hline
    ...
    \hline
    \textit{TLINT} & 8 Byte Ganzzahl (mit Vorzeichen) & ZLib/Base64\\
    \hline
    \textit{TULINT} & 8 Byte Ganzzahl (ohne Vorzeichen) &
    ZLib/Base64\\ \hline
