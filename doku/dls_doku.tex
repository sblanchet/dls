...
\item[dls\_status] Zur allgemeinen Überwachung der Datenerfassung
  dient das Script \textit{dls\_status}\index{dls\_status}. Es ist ein
...
\item[SIGSEGV u. A.] Diese Signale werden zur Sicherheit überwacht und
  vom dlsd-Mutter\-prozess und -Erfassungsprozess gleichartig
...
und kompiliert werden. Der \texttt{configure}-Befehl kennt zwei
zusätzliche Parameter \texttt{--with-fltk-dir} und
\texttt{--with-fftw3-dir} um die (abweichenden)
Installationsverzeichnisse der jeweiligen Bibliotheken anzugeben. Das
Standard-Installationsverzeichnis des DLS is \textit{/opt/etherlab}.
Ein anderes Verzeichnis kann mit dem Parameter \texttt{--prefix}
angegeben werden.
